...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    // Hook these to your Input Action:
    // Jump.started or .performed -> hold = true, buffer
    // Jump.canceled -> hold = false
    public void OnJump(InputAction.CallbackContext ctx)
    {
        // Callbacks for when jump started, performed, or canceled
        if (ctx.started || ctx.performed) { _jumpHeld = true;  _jumpBufferTimeElapsed = jumpBuffer; }
